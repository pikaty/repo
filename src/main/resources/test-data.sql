insert into contact (first_name, last_name, birth_date) values ('Clarence' , 'Ho1' , '1980-07-30') ;
insert into contact (first_name, last_name, birth_date) values ('Scott1' , 'Tiger1' , '1990-11-02');
